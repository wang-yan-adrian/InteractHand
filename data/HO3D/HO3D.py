...
class HO3D(torch.utils.data.Dataset):
    ...
    def load_data(self):
        ...
        for aid in db.anns.keys():
            ...
            hand_seg_path = osp.join(self.hand_root, self.data_split, "hand", img['file_name'])
            # TEMP
            ...
            if self.data_split == 'train':
                ...
                data = {"img_path": img_path, "img_shape": img_shape, "joints_coord_cam": joints_coord_cam, "joints_coord_img": joints_coord_img,
                        "bbox": bbox, "cam_param": cam_param, "mano_pose": mano_pose, "mano_shape": mano_shape, "hand_seg_path": hand_seg_path}
            else:
    ...
    def __getitem__(self, idx):
        ...
        img_hand, img_hand2bb_trans, bb2img_hand_trans, rot, scale = augmentation(img_hand, bbox, self.data_split, do_flip=False)
        img_hand = self.transform(img_hand.astype(np.float32))/255. 
        ...
        if self.data_split == 'train':
            ...
            inputs = {'img': img, 'img_hand': img_hand}
